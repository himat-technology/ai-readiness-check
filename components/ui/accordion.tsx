  ...
  return (
    <AccordionPrimitive.Header className="flex">
      <AccordionPrimitive.Trigger
        className={cn(
          "flex flex-1 items-center justify-between py-4 text-left text-sm font-semibold text-slate-900 transition hover:text-teal-800 [&[data-state=open]>svg]:rotate-180",
          className
        )}
        {...props}
      >
